...
I thought this would be a great opportunity to challenge myself to design a system that accomplished the requirements of the interactive without using a microcontroller, which led me into a fantastic journey where I learned about 555 timers, MOSFETs, PCB design and manufacturing, and more. This repository documents that process, and includes schematics, design decisions, and links to relevant datasheets.
